...
//    _violateReason = [[UILabel alloc]initWithFrame:[framsizeclass newSuitFrame:CGRectMake(108, 32, 150, 16)]];
    ...
    UILabel *  labe2 = [[UILabel alloc]initWithFrame:[framsizeclass newSuitFrame:CGRectMake(20, 50, 48, 16)]];
    labe2.text=@"项目:";
...
//    _priject = [[UILabel alloc]initWithFrame:[framsizeclass newSuitFrame:CGRectMake(73, 50, 100, 16)]];
    ...
    UILabel *  label21 = [[UILabel alloc]initWithFrame:[framsizeclass newSuitFrame:CGRectMake(20, 68, 64, 16)]];
    label21.text=@"成本中心:";
...
//    _concent= [[UILabel alloc]initWithFrame:[framsizeclass newSuitFrame:CGRectMake(90, 68, 120, 16)]];
