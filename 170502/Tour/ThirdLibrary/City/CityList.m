...
- (void)viewDidLoad {
    ...
    [super viewDidLoad];
    tarView=[[UIView alloc]initWithFrame:CGRectMake(0, 0, ScreenWidth,64)];
    tarView.backgroundColor= [UIColor colorWithRed:7/255.0 green:68/255.0 blue:130/255.0 alpha:1];
    ...
    //设置搜索框
    self.searchBar = [[UISearchBar alloc]initWithFrame:CGRectMake(20, 20, ScreenWidth-40, 40)];
    ...
    self.mainTable = [[UITableView alloc]initWithFrame:CGRectMake(0, 64, ScreenWidth, ScreenHeight-64)];
    self.mainTable.delegate = self;
    self.mainTable.dataSource = self;
    self.mainTable.tableFooterView = [UIView new];
    self.mainTable.sectionIndexColor=[UIColor blueColor];
    self.mainTable.sectionIndexTrackingBackgroundColor = [UIColor grayColor];
    [tarView addSubview:self.searchBar];
...
-(UICollectionViewCell *)collectionView:(UICollectionView *)collectionView cellForItemAtIndexPath:(NSIndexPath *)indexPath{
    ...
    if (indexPath.section == 0) {
        ...
        cell.titleLabel.text = hostCities[indexPath.row];
         cell.titleLabel.textColor=[UIColor colorWithRed:74/255.0 green:74/255.0 blue:74/255.0 alpha:1];
...
-(UICollectionReusableView *)collectionView:(UICollectionView *)collectionView viewForSupplementaryElementOfKind:(NSString *)kind atIndexPath:(NSIndexPath *)indexPath{
    ...
    if ([kind isEqualToString:UICollectionElementKindSectionHeader]){
        if (indexPath.section == 0) {
            view.sectionTitleLabel.text = @"当前城市";
