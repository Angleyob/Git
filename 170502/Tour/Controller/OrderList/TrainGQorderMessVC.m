...
@interface TrainGQorderMessVC ()<UITableViewDelegate,UITableViewDataSource>
...
@implementation TrainGQorderMessVC
...
-(void)loadData{
    TrainChangeInfQuery * fcif = [TrainChangeInfQuery new];
    ...
    [Train TrainChangeInfQuery:fcif success:^(id data) {
        // NSLog(@"%@",data);
    ...
    switch (indexPath.section) {
        case 0:{
            ...
            [cell setSelectionStyle:UITableViewCellSelectionStyleNone];
                if(indexPath.row==0){
                    cell.orderlabel.text=[NSString stringWithFormat:@"新订单号:%@",_Messagedict[@"changeId"]];
                    ...
                    cell.trainNO.text=_Messagedict[@"newTrainNum"];
                    cell.fromstation.text=_Messagedict[@"fromStationName"];
                    cell.fromdata.text=[_Messagedict[@"newDepartureDate"] substringFromIndex:5];
                    cell.fromtime.text=_Messagedict[@"newDepartureTime"];
                    cell.tostation.text=_Messagedict[@"toStationName"];
                    cell.totime.text=_Messagedict[@"newArrivalsTime"];
                    cell.todate.text=[_Messagedict[@"newArrivalsDate"] substringFromIndex:5];
                    return cell;
                }else{
                    //去除点击效果
                    [cell setSelectionStyle:UITableViewCellSelectionStyleNone];
                    ...
                    cell.trainNO.text=_Messagedict[@"oldTrainNum"];
                    cell.fromstation.text=_Messagedict[@"fromStationName"];
                    cell.fromdata.text=[_Messagedict[@"oldDepartureDate"] substringFromIndex:5];
                    cell.fromtime.text=_Messagedict[@"oldDepartureTime"];
                    cell.tostation.text=_Messagedict[@"toStationName"];
                    cell.totime.text=_Messagedict[@"oldArrivalsTime"];
                    cell.todate.text=[_Messagedict[@"oldArrivalsDate"] substringFromIndex:5];
        ...
        case 1:{
            ...
            cell.IdNumlabel.text=_menarray[indexPath.row][@"passportNum"];
