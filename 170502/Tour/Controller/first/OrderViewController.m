...
-(void)initview{
    ...
    view1.layer.shadowOffset=CGSizeMake(0.01, 3/SCREEN_RATE1);
...
//    flabel.font=[UIFont systemFontOfSize:14];
    ...
    view2.layer.shadowOffset=CGSizeMake(0.01, 3/SCREEN_RATE1);
    ...
    view3.layer.shadowOffset=CGSizeMake(0.01, 3/SCREEN_RATE1);
