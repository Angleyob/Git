...
@implementation TcheckViewtwo

-(void)initView{
    self.backgroundColor=[UIColor colorWithRed:246/255.0 green:246/255.0 blue:246/255.0 alpha:1];
    
    UILabel *  label = [[UILabel alloc]initWithFrame:[framsizeclass newSuitFrame:CGRectMake(20, 5, 34, 16)]];
    label.text=@"项目:";
    ...
    //    _priject = [[UILabel alloc]initWithFrame:[framsizeclass newSuitFrame:CGRectMake(73, 5, 150, 16)]];
    ...
    //    _concent = [[UILabel alloc]initWithFrame:[framsizeclass newSuitFrame:CGRectMake(90, 32, 150, 16)]];
