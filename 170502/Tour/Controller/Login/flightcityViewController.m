...
@interface flightcityViewController ()<UITableViewDelegate,UITableViewDataSource,UICollectionViewDataSource,UICollectionViewDelegate,UICollectionViewDelegateFlowLayout,UISearchResultsUpdating>
{
...
@end
@implementation flightcityViewController
...
- (void)viewDidLoad {
    ...
    NSArray * arr1 = @[@"北京",@"上海浦东",@"上海虹桥",@"广州",@"深圳"];
    ...
    table = [[UITableView alloc] initWithFrame:CGRectMake(0, 114, self.view.frame.size.width, self.view.frame.size.height-64)];
    table.delegate = self;
